...
exports.listMyItems = exports.removeFromList = exports.addToList = void 0;
...
const addToList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let userList = yield UserList_1.default.findOne({ userId: MOCK_USER_ID });
        if (!userList) {
            // Create new list if not exists for the mock user
            userList = new UserList_1.default({
                userId: MOCK_USER_ID,
        ...
        yield userList.save(); // Save the updated list
...
const removeFromList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userList = yield UserList_1.default.findOne({ userId: MOCK_USER_ID });
        if (!userList) {
 ...
 * @param res Express Response object
 */
const listMyItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.listMyItems = listMyItems;
