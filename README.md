...
Storing contentIds as an array directly within the UserList document, minimizing database queries for list retrieval.
...
Prerequisites
Node.js: (v18 or higher recommended) - Download & Install Node.js
npm: (Node Package Manager, comes with Node.js)
MongoDB: (running locally or accessible via a connection string) - Download & Install MongoDB Community Server
Installation
...
npm run seed
This script connects to your MONGO_URI, deletes any existing UserList data, and then adds a mock user with a few sample contentIds.
...
Build the TypeScript code (compiles to JavaScript in dist folder):
Bash
...
Base URL (Local Development): http://localhost:5000/api/my-list Base URL (Deployed): https://my-list-service-backend.onrender.com/api/my-list
